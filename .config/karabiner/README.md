...
The _Hyper Key_, or `Ctrl+Opt+Shift+Cmd`, acts as a universal layer key, unlocking submaps for:
...
| n   | Things3     | Launch task manager    |
| p   | Skim        | Launch PDF viewer      |
| c   | Zed         | Launch code editor     |

# Hyper + W (Window)

| Key                 | Action               | Description                     |
| ------------------- | -------------------- | ------------------------------- |
| spacebar            | Mission Control      | Open macOS Mission Control      |
...
| x                   | Reasonable Size      | Resizes to ideal central bounds |
