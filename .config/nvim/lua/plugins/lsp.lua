return {
	{
		...
		config = function()
			...
			local servers = {
				...
				lua_ls = {
					root_dir = require("lspconfig.util").root_pattern(".git", ".luarc.json", "init.lua"),
					-- cmd = { ... },
					-- filetypes = { ... },
					-- capabilities = {},
					settings = {
			...
			vim.list_extend(ensure_installed, {
				...
				"emmet-language-server", -- Used to generate html tags easily
			})
			...
			require("mason-lspconfig").setup({
				...
				handlers = {
					-- Automatic detection from Mason
					function(server_name)
						local server = servers[server_name] or {}
						server.capabilities = vim.tbl_deep_extend("force", {}, capabilities, server.capabilities or {})
						require("lspconfig")[server_name].setup(server)
					end,
					-- Manual setting of servers
					-- function(server_name)
					-- 	local server = servers[server_name] or {}
